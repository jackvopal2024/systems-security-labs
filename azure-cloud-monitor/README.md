...
This project is a Linux-based monitoring and intrusion detection system deployed on an Azure virtual machine. It was built to simulate real-world systems operations tasks such as service monitoring, failure recovery, and basic security analysis.
